    ...
    <body>
        ...
        <form action="cadastroAluno.php" method="post">
            ...
            <table class="formTable">
                <tr><td>RA    :</td><td><input type="text" name="inputRA"     id="inputRA"    ></td></tr>
                <tr><td>Nome  :</td><td><input type="text" name="inputNome"   id="inputNome"  ></td></tr>
                <tr><td>Rua   :</td><td><input type="text" name="inputRua"    id="inputRua"   ></td></tr>
                <tr><td>Numero:</td><td><input type="text" name="inputNumero" id="inputNumero"></td></tr>
                <tr><td>Bairro:</td><td><input type="text" name="inputBairro" id="inputBairro"></td></tr>
                <tr><td>Cidade:</td><td><input type="text" name="inputCidade" id="inputCidade"></td></tr>
                <tr><td>Estado:</td><td><input type="text" name="inputEstado" id="inputEstado"></td></tr>
            </table>
